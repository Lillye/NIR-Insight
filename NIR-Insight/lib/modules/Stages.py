...
class LoadImage:
    ...
    def Process(self, input, i):
        ...
        if self.showImage:
            cv.imshow(f"{str(i)} Original", output)
            cv.imwrite(f"./out/{str(i)} Original.jpg", output)
        return output
...
class Threshold:
    ...
    def Process(self, input, i):
        ...
        if self.showImage:
            cv.imshow(f"{str(i)} Binary",output)
            cv.imwrite(f"./out/{str(i)} Binary.jpg", output)
        return output
...
class Morph:
    ...
    def Process(self, input, i):
        ...
        if self.showImage:
            cv.imshow(f"{str(i)} {str(self.type)}", output)
            cv.imwrite(f"./out/{str(i)} {str(self.type)}.jpg", output)
        return output
...
class AdaptiveHistogramEqualization:
    ...
    def Process(self, input, i):
        ...
        if self.showImage:
            cv.imshow(f"{str(i)} Eq", output)
            cv.imwrite(f"./out/{str(i)} Eq.jpg", output)
        return output
...
class Rotate:
    ...
    def Process(self, input, i=0):
        ...
        if self.showImage:
            cv.imshow(f"{str(i)} Rotation", output)
            cv.imwrite(f"./out/{str(i)} Rotation.jpg", output)
        return output
...
class GetApproximateAngle:
    ...
    def Process(self, input, i):
        ...
        if self.showImage:
            ...
            cv.imshow(f"{str(i)} Ellipse",eli)
            cv.imshow(f"{str(i)} Line",image)
            cv.imwrite(f"./out/{str(i)} Ellipse.jpg", eli)
            cv.imwrite(f"./out/{str(i)} Line.jpg", image)
        (x1, y1) = p1
        (x2, y2) = p2
...
class Invert:
    ...
    def Process(self, input, i):
        ...
        if self.showImage:
            cv.imshow(f"{str(i)} Invert",inv)
            cv.imwrite(f"./out/{str(i)} Invert.jpg", inv)
        return inv
...
class Skeletonize:
    ...
    def Process(self, input, i):
        ...
        sk = img_as_ubyte(sk)
        if self.showImage:
            cv.imshow(f"{str(i)} Thin",sk)
            cv.imwrite(f"./out/{str(i)} Thin.jpg", sk)
        return sk
